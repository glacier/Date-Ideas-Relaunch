...
class YelpAPI
  ...
  def initialize(consumer_key, consumer_secret, token, token_secret, test_mode = false)
...
yelp_api = YelpAPI.new('Z720kWRw-CAauOQNUbMEAQ', 'e7999uMADazHkmG5NDVDWBykczc', '1Gj9nSZwzv_o5F_egAYGgYDBsdTdeKFZ', 'Yd98KQPlSAOWXfmHYsTctbihEH4', false)
